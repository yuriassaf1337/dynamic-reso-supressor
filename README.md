...
For those who may just want to test the plugin and don't necessarily want to compile it by themselves, I've also added (Silicon) MacOS VST-AU binaries as releases if you want to download it (if there's enough interest I can add other platforms). MacOS will flag the files since they're not registered, one possible solution can be found here https://www.motunation.com/forum/viewtopic.php?t=72872. It involves removing the files from quarantine: 
...
* **MakeUp**: Simple gain, necessary since you're removing energy from the signal but likely want mainly to remove the strength of the resonances.  
